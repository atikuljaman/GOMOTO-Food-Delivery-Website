                            ...
                            blogs.map(blog => (
                                <Col className="mb-5">
                                    <Card className="border-0 blog-card">
                                        <Card.Img variant="top" className="img-fluid blog-img" src={blog?.img} />
                                        <Card.Body className="px-0">
                                            <button className="blog-btn border-0 text-white fw-bold mb-3">{blog?.ctg}</button>
                                            <Card.Title>
                                                <h3 className="fw-bold">{blog?.name}</h3>
                                            </Card.Title>
                                            <Card.Text>
                                                <p className="pt-2 pb-3 blog-desc"><small>{blog?.desc}</small></p>
                                                <div className="d-flex blog-publish">
                                                    <p className=""><FaCalendarAlt className="blog-icon" /> <small>{blog?.date}</small></p>
                                    ...
                                    <div>
                                        <NavLink className="d-block" to="">
                                            <button className="border-0 bg-transparent category-btn"><BiChevronRight className="category-icon" />
                                                <small>Food Delivery (<small>{foodDeliveries.length})</small></small>
                                            </button>
                                        </NavLink>
                                        <NavLink className="d-block" to="">
                                            <button className="border-0 bg-transparent category-btn"><BiChevronRight className="category-icon" />
                                                <small>Medical (<small>{Medicals.length})</small></small>
                                            </button>
                                        </NavLink>
                                        <NavLink className="d-block" to="">
                                            <button className="border-0 bg-transparent category-btn"><BiChevronRight className="category-icon" />
                                                <small>GOMOTO (<small>{GOMOTOS.length})</small></small>
                                            </button>
                                        </NavLink>
                                    </div>
                                </div>
